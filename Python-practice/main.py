...
# PranaliValve = "students" #pascal case

# pranaliValve = "students" #camel case

# pranali_valve = "students" #snake case
...
# information(name = "Pranali", age = 23, designation = "AI/ML")
